    ...
    <div className="flex flex col lg:flex-row gap-6 h-full">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
          ...
          <form className="space-y-5" onSubmit={handleSchedule}>
            ...
            <div>
              ...
              />
              <div
                className={` text-xs text-right mt-1 font-medium ${content.length > 270 ? "text-red-500" : "text-slate-400"}`}
              >
                {content.length}/280
              </div>
            </div>
            ...
            <div>
              <label className="text-xs block text-slate-500 uppercase mb-2">
                Media (optional)
              </label>
              {mediaFile ? (
                <div className="border border-slate-200 bg-slate-50 rounded-xl relative overflow-hidden ">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="date"
                    required
                    className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border-slate-200 rounded-lg text-slate-900 text-sm outline-none"
                  />
                </div>
              </div>
              {/* Time */}
      ...
      <div className="flex-1 flex flex-col gap-6 min-w-0">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
          ...
          <div className="max-h-72 overflow-y-auto divide-y divide-slate-50/60 transition-colors">
            {scheduled.length === 0 ? (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs bg-emerald-50 text-emerald-700 border border-emerald-100 px-2 py0.5
                      rounded-full">Published</span>
                    </div>
                  </div>
                  <p className="text-sm text-slate-500 line-clamp-2 max-w-full mt-4">
                    {post.content}
                  </p>
                </div>
              ))
