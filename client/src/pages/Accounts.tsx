...
const Accounts = () => {
  ...
  useEffect(() => {
    ...
    if (connectedPlatform) {
      ...
      const handle = connectedPlatform ? ` (@${connectedUsername})` : "";
      void fetchAccounts(
        true,
        connectedPlatform,
  ...
  //   setTimeout(() => {
  //     setConnecting(null);
  //     // ✅ Find the dummy account for the chosen platform
  //     const newAccount = dummyAccountsData.find(
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      {/* Header */}
      <div className="flex flex-col  items-start sm:flex-row sm:items-center justify-between gap-4 text-sm">
        <div>
